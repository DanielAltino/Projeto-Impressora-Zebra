...
public class FingerprintActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(FingerprintActivity.this, ex.getMessage(),
 ...
 */
    ...
    public void onClick(View view) {
        if (!isPower) {
            Toast.makeText(FingerprintActivity.this, "The fingerprints did not run powered on!", Toast.LENGTH_SHORT).show();
            return;
        }
        switch (view.getId()) {
            case R.id.btnEnroll:
                ...
                Toast.makeText(FingerprintActivity.this, "The FINGERPRINT ACTIVITY!", Toast.LENGTH_SHORT).show();
                buff = null;
                id = -1;
                tvInfo.setText("");
            ...
            case R.id.btnCleanAll:
                ...
                Toast.makeText(FingerprintActivity.this, "CleanAll：" + result, Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.btnGoToMain:
                ...
                Intent mainIntent = new Intent(FingerprintActivity.this, FormActivity.class);
    ...
    public class InitTask extends AsyncTask<String, Integer, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (!result) {
                isPower = false;
                Toast.makeText(FingerprintActivity.this, "init fail",
                        Toast.LENGTH_SHORT).show();
            } else {
                isPower = true;
                Toast.makeText(FingerprintActivity.this, "init success", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        protected void onPreExecute() {
            ...
            mypDialog = new ProgressDialog(FingerprintActivity.this);
